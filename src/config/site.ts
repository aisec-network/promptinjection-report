...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "OWASP LLM01, tracked and explained." },
...
export const siteConfig: SiteConfig = {
  domain: "promptinjection.report",
  url: "https://promptinjection.report",
  title: "Prompt Injection Report",
  tagline: "Prompt injection PoCs, taxonomy, and primary sources.",
  description:
  ...
  byline: "Prompt Injection Report Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 200, cluster: "offensive" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@promptinjection.report",
    abuse: "abuse@promptinjection.report",
    editor: "editor@promptinjection.report",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "promptinjection.report"),
  analytics: {},
};
